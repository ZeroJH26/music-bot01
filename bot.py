...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if is_spotify_url(text):
            await status.edit_text("🎵 Получаю информацию с Spotify…")
            ...
            await status.edit_text(f"📥 Скачиваю: <b>{query}</b>…", parse_mode="HTML")
            ...
            await status.edit_text(f"🔍 Ищу: <b>{text}</b>…", parse_mode="HTML")
